# Координатор GrowerHub для Raspberry Pi/Linux

1. Установите Docker Engine с модулем Compose.
...
Каталог `data` хранит данные постоянно и сохраняет Zigbee-сеть после перезапуска. В образ и Compose-файл не встроены персональные данные доступа MQTT.
