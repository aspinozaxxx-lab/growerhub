    ...
    <div className="section">
      ...
      <div className="section" style={{ marginTop: 18 }}>
        ...
        <ul className="contact-list">
          ...
          <li><strong>????:</strong> <a href={aboutContent.contacts.site}>{aboutContent.contacts.site}</a></li>
          <li><strong>????????:</strong> <a href={aboutContent.contacts.telegram}>{aboutContent.contacts.telegram}</a></li>
        </ul>
      </div>
    </div>
  );
