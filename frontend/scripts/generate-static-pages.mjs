          ...
          <section class="content-section" id="demo-ekrany">
            ...
            <div class="demo-grid demo-grid--four">
              <figure class="demo-card">
                <img class="product-screenshot" src="/screenshots/zones.webp?v=${overviewScreenshotVersion}" alt="Четыре теплицы и состояние оборудования в обычном кабинете. Данные демо смоделированы." width="1280" height="${overviewScreenshotDimensions.ru.height}" loading="eager">
...
const renderEnglishLegalPage = (template, assets, legal, type) => {
  ...
  const body = privacy ? `
          ...
          <h2>Web analytics</h2><p>Yandex Metrica and Google Analytics 4 help us understand visits and platform setup progress. Events include the page address, interface language and non-personal scenario parameters. We do not send email addresses, internal identifiers, IEEE addresses or MQTT credentials to analytics.</p>
