...
РћСЃРЅРѕРІРЅР°СЏ Р»РѕРіРёРєР° СЂР°Р·РјРµС‰РµРЅР° РІ РєР°С‚Р°Р»РѕРіРµ `server/app/fastapi/routers/mqtt/` Рё СЂР°Р·РґРµР»РµРЅР° РїРѕ РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕСЃС‚СЏРј:
