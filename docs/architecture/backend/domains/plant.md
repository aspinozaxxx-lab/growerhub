...
Домен владеет растениями и samples метрик растения. Размещение растения в теплице и скорость полива принадлежат automation; журнал и pump sessions принадлежат своим доменам.
