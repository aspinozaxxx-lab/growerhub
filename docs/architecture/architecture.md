...
Grovika публикует единственный датчик почвы как `soil.ports[0]` с `port/channel=0`; другие soil-каналы для Grovika не входят в контракт и backend их не принимает.
