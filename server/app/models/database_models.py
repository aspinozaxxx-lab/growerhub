...
class PlantJournalWateringDetailsDB(Base):

    """Translitem: detali poliva dlya zapisi zhurnala (obem, dlitelnost, ph, udobreniya)."""



    __tablename__ = "plant_journal_watering_details"
    ...
    water_volume_l = Column(Float, nullable=False)

    duration_s = Column(Integer, nullable=False)

    ph = Column(Float, nullable=True)

    fertilizers_per_liter = Column(Text, nullable=True)



    journal_entry = relationship("PlantJournalEntryDB", back_populates="watering_details")
