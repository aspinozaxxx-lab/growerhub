...
- ansible-playbook -i inventory/hosts.ini playbooks/nginx.yml   -u watering-admin --ask-become-pass   -e ansible_become=yes - Тоже Ngingx - альтернатива со всеми параметрами
