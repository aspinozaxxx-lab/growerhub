...
- 🚀 **Авто-деплой:** systemd сервис с переодической запроса новых коммитов
...
- ansible-playbook playbooks/nginx.yml -K            # развертывание службы Nginx на сервере
  - 🖥️ FastAPI, порт 8000, IP: 192.168.0.11 и Growerhub.ru (http://growerhub.ru/redoc)
  - GrowerHub.ru - основной сайт продукта (80, 443, 8000 порты проброшены на роутере на сервер 192.168.0.11  
