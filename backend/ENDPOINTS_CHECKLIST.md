...
| PATCH | /api/plants/{plant_id} | DONE |
| DELETE | /api/plants/{plant_id} | DONE |
| POST | /api/plants/{plant_id}/devices/{device_id} | DONE |
| DELETE | /api/plants/{plant_id}/devices/{device_id} | DONE |
| GET | /api/plants/{plant_id}/journal | DONE |
| GET | /api/plants/{plant_id}/journal/export | DONE |
| POST | /api/plants/{plant_id}/journal | DONE |
| PATCH | /api/plants/{plant_id}/journal/{entry_id} | DONE |
