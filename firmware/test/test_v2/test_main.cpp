...
int main(int argc, char** argv) {
  ...
  RUN_TEST(test_wifi_defaults_merge_legacy_user_config);
  RUN_TEST(test_wifi_explicit_config_preserves_deleted_builtins);
  ...
  RUN_TEST(test_wifi_config_max_networks_fit_buffer);
  RUN_TEST(test_webconfig_build_json);
  RUN_TEST(test_webconfig_shows_builtin_networks_without_user_config);
  RUN_TEST(test_webconfig_merges_builtin_and_manual_networks);
  RUN_TEST(test_webconfig_content_is_russian);
  ...
  RUN_TEST(test_hardware_profile_sensor_pins);
