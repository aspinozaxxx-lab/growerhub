...
static const char kWebHtml[] =
    ...
    "<div class=\"status-title\">Состояние</div>"
    ...
    "</form>"
    "<div class=\"list\">"
    "<div class=\"list-title\">Сохранённые сети</div>"
    "<div id=\"networks\"></div>"
    "</div>"
    "</div>"
    "</div>"
...
static const char kWebJs[] =
    ...
    "  if (!res.ok) {\n"
    "    setStatus('Не удалось загрузить сети', false);\n"
    "    return;\n"
    "  }\n"
    ...
    "    empty.textContent = 'Сохранённых сетей нет';\n"
    ...
    "        setStatus(msg || 'Не удалось удалить сеть', false);\n"
    "      }\n"
    "    });\n"
    ...
    "  if (!ssid) {\n"
    "    setStatus('Укажите имя сети', false);\n"
    "    return;\n"
    "  }\n"
    "  const res = await fetch('/api/networks', {\n"
    "    method: 'POST',\n"
    ...
    "    setStatus(msg || 'Не удалось сохранить сеть', false);\n"
    "  }\n"
    "});\n"
    "\n"
    "loadNetworks();\n";
